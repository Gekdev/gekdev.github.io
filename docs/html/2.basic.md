...
* Google Fonts : 가장 좋은 웹 폰트 사이트 
<span class="fs-2">
[Google Fonts](https://fonts.google.com/){: .btn .btn-outline}
</span>

### Icon

* Font Awesome : 웹에서 폰트를 가져올 수 있음
<span class="fs-2">
[Font Awesome](https://fontawesome.com/){: .btn .btn-outline}
</span>
...
<span class="fs-2">
[특수문자 사이트](https://dev.w3.org/html5/html-author/charref){: .btn  .btn-outline}
</span>
