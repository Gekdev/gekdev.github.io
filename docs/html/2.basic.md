...
Empty tags : HTML tags with no content. Empty tags do not have an end tag, such as the `<br>` element
...
<span class="fs-2">
[Google Fonts](https://fonts.google.com/){: .btn .btn-blue .mt-3}
</span>

### Icon

<span class="fs-2">
[Font Awesome](https://fontawesome.com/){: .btn .btn-blue .mt-3}
</span>
