...
쉽게 말해 인터넷을 고속도로로 비유한다면 웹은 고속도로를 이용하는 물류산업이다
...
* 서버이름 (도메인 or IP주소)
    ...
    IP주소 : 웹서버가 실행중인 컴퓨터의 주소 (웹브라우저가 웹서버에 연결하려면 알아야 함)
...
* 에이쿨첵!
    ...
    **웹 접근성 솔루션 검사 프로그램**
    ...
    <span class="fs-2">
    [다운로드 페이지](https://software.naver.com/software/summary.nhn?softwareId=GWS_000915#){: .btn .btn-blue .mt-3}
    </span>
